...
public class DownloadVersion extends AsyncTask<String, Integer, String> {
    public interface downloadTaskCallBack {
        ...
        void successCallBack(String result, String filepath);
    }
    ...
    public DownloadVersion(Context context) {
    ...
    protected String doInBackground(String... sUrl) {
        ...
        try {
            ...
            output = new FileOutputStream(folder + "/" + file);
            filePath = Environment.getExternalStorageDirectory() + "/" + file;
    ...
    protected void onPostExecute(String result) {
        mWakeLock.release();
        this.callBack.successCallBack(result,filePath);
    }
}
